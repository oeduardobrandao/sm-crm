...
Deno.serve(async (req) => {
  ...
  // Auth: JWT OAuth do Supabase (passa por --no-verify-jwt).
  ...
  // Per-request server: tools are bound to THIS admin's ctx + scopes (stateless).
  ...
  registerTools(server, {
    ...
    storageQuota: (contaId) => effectivePlanLimit(db as never, contaId, "storage_quota_bytes"),
  });

...
Deno.test("validatePopupFields: par de CTA, until_cta, require_ack, tamanhos e formato da URL", () => {
  ...
  assert(validatePopupFields({ ...base, cta_label: "Ver", cta_url: "/\\evil.com" }) !== null, "cta_url com /\\ deve falhar");
  assert(validatePopupFields({ ...base, cta_label: "Ver", cta_url: "/\t\\evil.com" }) !== null, "cta_url com tab+/\\ deve falhar");
  assert(validatePopupFields({ ...base, cta_label: "Ver", cta_url: "/\t/evil.com" }) !== null, "url com tab");

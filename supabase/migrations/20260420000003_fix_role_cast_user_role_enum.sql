-- =============================================
-- Fix: profiles.role is type `user_role` (enum),
-- not text. The debug trigger from
-- 20260420000002 exposed:
--   column "role" is of type user_role but
--   expression is of type text
-- Cast meta_role::user_role on every insert/update.
-- Keep the BEGIN/EXCEPTION wrappers so future

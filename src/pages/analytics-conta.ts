...
<body>
  ...
  <div class="report-footer" style="text-align:center">
    ${workspaceName ? `<div style="font-weight:600;margin-bottom:4px">${escapeHTML(workspaceName)} · Relatório de Performance · ${dateStr}</div>` : ''}
    <div style="opacity:0.5;display:flex;align-items:center;justify-content:center;gap:6px;font-size:9px;flex-direction:column">
      <div>Gerado por</div> 
      <div>${mesaasLogoSvg}</div>
    </div>
  </div>
</body>
</html>`;

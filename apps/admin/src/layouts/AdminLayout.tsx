                ...
                >
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <stop offset=".28" stopColor="#EA0E78" />
                      <stop offset=".58" stopColor="#FE3452" />
                      <stop offset=".76" stopColor="#FE7340" />
                      <stop offset="1" stopColor="#FFC32E" />
                    </linearGradient>
                  </defs>
                </svg>
                <span className="text-[0.6rem] font-medium text-[#9ca3af] uppercase tracking-widest">
                  admin
                </span>
              </div>
              <button
                onClick={() => setSidebarOpen(false)}
                className="md:hidden text-[#9ca3af] hover:text-[#e8eaf0]"
              >
                <X size={18} />
              </button>
            </div>
              ...
              <div className="flex items-center justify-between mb-1">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <button
                    ...
                    title={
                      glassEnabled
                        ? 'Liquid Glass: ON (click to disable — reloads)'
                        : 'Liquid Glass: OFF (click to enable — reloads)'
                    }
                  >
                    <Sparkles size={14} />
                  </button>

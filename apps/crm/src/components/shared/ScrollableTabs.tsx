...
export function ScrollableTabs({
  ...
  return (
    <div className={`scrollable-tabs ${className}`}>
      <div
        ref={scrollerRef}
        onScroll={sync}
        role="tablist"
      ...
      {canScrollLeft && (
        <span className="scrollable-tabs-fade scrollable-tabs-fade-left" aria-hidden="true" />
      )}
      {canScrollRight && (
        <span className="scrollable-tabs-fade scrollable-tabs-fade-right" aria-hidden="true" />
      )}

      {canScrollLeft && (
        <ScrollButton side="left" label="Ver abas anteriores" onClick={() => scrollByPage(-1)} />
      )}
      {canScrollRight && (
        <ScrollButton side="right" label="Ver mais abas" onClick={() => scrollByPage(1)} />
      )}
    </div>
  );
}
...
function ScrollButton({
  ...
  return (
    <button
      ...
      aria-label={label}
      onClick={onClick}
      className={`scrollable-tabs-arrow scrollable-tabs-arrow-${side}`}
    >

...
- O que acontece depois que alguém manda mensagem: quem responde, quando, por onde.
...
- Descreva os três últimos clientes que fecharam: o que cada um perguntou antes de fechar?
- Qual pergunta você responde toda semana, no direct ou no balcão?
- Quem pede orçamento e não fecha — o que ela diz quando não fecha?
...
- **Palavras.** Que termos a marca não usa, e o que entra no lugar. Proibição sem substituto diz o que não escrever, não o que escrever.
- **Promessas e números.** O que não pode ser prometido — resultado, prazo, garantia — e que números podem ir a público: faturamento, clientes, nome de cliente.
- **Regra da categoria.** Saúde, direito, finanças e alimentação têm órgão com regra própria: qual é o dele, o que proíbe, quem assina a peça. Responsável técnico é etapa com prazo, não favor de última hora.
- **Nomes.** Quem não pode ser citado, marcado nem aparecer ao fundo: concorrente, ex-sócio, fornecedor antigo. E o parceiro que sempre é marcado.
...
- O que precisa acontecer no negócio para você dizer que valeu: venda, orçamento, agendamento, gente na loja?
...
O briefing define o que pode ser dito; quem diz sim e em quanto tempo é outro combinado, em [como organizar a aprovação de posts](/blog/como-organizar-aprovacao-de-posts). Decisão que não está escrita não tem como ser conferida depois — só refeita.

...
1. Copie o pedido para o post, você mesmo, no mesmo minuto.
2. Responda por lá uma linha só: "registrei no post, confirma no link?".
3. Não repita a explicação. Repetir a regra é corrigir o cliente.
...
1. **Pauta do mês, aprovada em bloco.** Até o dia [25], você recebe o calendário do mês seguinte com data, formato e tema de cada post, e tem [3 dias úteis] para aprovar ou ajustar. A produção segue a pauta aprovada.
2. **Produção e revisão interna.** A agência revisa antes de enviar: erro que a equipe pega sozinha não chega até você.
...
No Mesaas, quem aprova não faz cadastro: um link único abre o post como ele vai ao ar, e a resposta sai dali mesmo, do celular — a mecânica está em [aprovação de post](/aprovacao-de-post). O pedido de ajuste fica registrado no próprio material, e a equipe acompanha em que etapa cada post está pelo kanban de entregas. Esse mesmo endereço é o [portal do cliente](/portal-do-cliente), que sai na identidade visual da sua agência e não na de um fornecedor.

Há um comparativo com uma ferramenta dedicada só a essa etapa em [Mesaas ou Aprova Post](/blog/mesaas-vs-aprova-post).

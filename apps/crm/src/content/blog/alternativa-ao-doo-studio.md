...
Aviso de origem: este texto sai da equipe do Mesaas. Por isso o critério é rígido — cada frase sobre o Doo Studio vem do [site oficial](https://doostudio.com.br), lido em julho de 2026, e nada além disso.
...
- **A ferramenta cobre uma fatia do trabalho.** Ela resolve o planejamento, ou a aprovação, ou o comercial — e o resto continua na planilha. Uma fatia bem resolvida ainda deixa quatro abas abertas.
- **O cliente nunca adota.** Portal que pede cadastro, senha ou aplicativo morre na primeira semana. O cliente volta para o grupo do WhatsApp, e a trilha de aprovação some junto.
- **A operação continua repartida.** O post está numa ferramenta, o contrato numa pasta, a mensalidade num caderno e o feedback num áudio. Ninguém responde "o que falta para hoje" sem abrir três sistemas.
...
- **Studio**, o módulo de produção e conteúdo, que centraliza o fluxo do briefing à aprovação e publicação, com pautas, responsáveis, status, prazos e calendário editorial.
- **Doo Post**, com agendamento de publicações no Instagram e no LinkedIn, preview e sincronização de métricas.
- **Portais de clientes**, descritos como links rápidos para que os clientes aprovem pautas de conteúdo em um clique.
- **Doo CRM**, com leads, prospecção, funil de vendas, oportunidades, propostas e histórico comercial.
- **Gestor**, módulo de ERP e gestão operacional: financeiro, faturas, fiscal, assinaturas e contratos, além de estoque, frotas e ordens de serviço.
- **Doo Drive**, nuvem privada para ativos de marca e arquivos por cliente e projeto, com edição de documentos via OnlyOffice.
- **Doo Pulse**, uma rede social corporativa para comunicação e acompanhamento do time.
- **Playbooks de Marca**, com tom de voz e linha editorial guiados por IA — no site, um AI Branding Engine que analisa o perfil de Instagram da marca.
- **Conteúdo com IA**, descrito como legendas e criativos para redes em segundos.
- **Presença Digital**, com link na bio, encurtador com QR Code, formulários, cartões de visita digitais, quizzes, sites e landing pages.
...
**Aprovação sem login.** Cada cliente tem o seu link — nada de cadastro, senha ou aplicativo. Ele abre no celular, confere o material exatamente como vai ao ar e responde ali mesmo: aprovado, ou com o ajuste escrito — a mecânica inteira está em [aprovação de post](/aprovacao-de-post).
...
**Portal com a sua marca.** Quem assina a experiência no [portal do cliente](/portal-do-cliente) é a sua agência — cor e identidade suas. O acesso sai por token individual, revogável quando você quiser.
...
- **É Instagram-first.** A integração nativa é com o Instagram, pela API oficial do Meta. Se você precisa publicar em várias redes do mesmo lugar — LinkedIn incluído, que o Doo Studio anuncia no agendamento —, esse ponto pesa contra o Mesaas.
- **Não é editor de design.** O Mesaas organiza, aprova, agenda e publica o material; não desenha o carrossel nem edita o vídeo.
- **O agente de IA escreve, não desenha.** Pelo MCP ele enxerga o briefing da marca e devolve um rascunho no próprio fluxo, para você revisar. Não gera imagens com IA: a arte é produzida fora e anexada ao post.
- **Não é agendador multirredes.** Não existe caixa de entrada unificada de redes sociais nem publicação simultânea em vários canais.
- **Não é ERP.** O financeiro cobre contratos, mensalidades, despesas e MRR. Estoque, folha, frota e rotina fiscal estão fora do escopo.
...
5. **Ligue o Instagram do cliente ao teste.** A conexão pela API oficial do Meta destrava agendamento, publicação e métricas; sem ela sobra a tela de aprovação, e o teste responde metade da pergunta. Veja em [planos](/precos) o que cada opção libera.

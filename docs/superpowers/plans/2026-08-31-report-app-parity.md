...
Latência de finalização de D-1 (para calibrar a janela D-1..D-3): medido em D+1 (01/09) — views D-1 (31/08) em 31/08: 1496 → em 01/09: 1759 (+263, +17,6%, mudou bastante); reach_31d: 21176 → 21188 (+12, +0,06%); views_31d: 47625 → 47888 (+263, +0,55%, delta igual ao de D-1 isolado, ou seja, D-2/D-3 já estavam estáveis nesta amostra); conclusão: D-1 sozinho ainda sofre finalização relevante em 24h — janela D-1..D-3 mantida

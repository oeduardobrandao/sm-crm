...
3. Drop the functions (the four RPCs, `generate_recurring_tarefas`, `tarefa_serie_garantir_aberta`, `tarefa_serie_materializar`, the trigger functions, `tarefa_serie_subtarefas_validas`, `tarefa_next_date`, `tarefa_hoje_sp`).
